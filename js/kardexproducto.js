...
function imprimir(){
    ...
    var xope     = xid("filtroOperacion").value;
    var xmov     = xid("filtroMovimiento").value;
    var	url      = "modulos/fpdf/imprimir_movimientosproducto.php?xid="+idprod+
                   "&xproduct="+producto+
                   "&xlocal="+idlocal+
	           "&desde="+desde+
	           "&hasta="+hasta+
...
function salirKardexCarritoAlmacen(id,xid){
    ...
    var lurl  = 'partes-compras/progress.php?modo=hWebForm&aviso='+aviso;
