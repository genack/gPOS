...
function RawBuscarMovimiento(desde,hasta,nombre,codigo,filtrooperacion,marca,familia,
    ...
    var url = "selkardex.php?modo=kdxMovimientosInventario"+xcadena
...
function RawBuscarAlmacen(nombre,codigo,familia,marca,stock,
    ...
    var url = "selkardex.php?modo=kdxAlmacenInventario"
	+ "&familia=" + escape(familia)
        + "&marca=" + escape(marca)
        + "&xinventario=" + escape(cInventario)
        + "&xnombre=" + escape(nombre)
...
function BuscarOperacionLocal(xid){
    ...
    window.location.href='modalmacenborrador.php?'+
	                 'modo=verInventario&'+
	                 'xlocal='+xid;
}
...
function finalizaOperacionInventario(){
    ...
    var url    = "selkardex.php?modo=kdxFinalizaInventario"
	         + "&xidinventario=" + escape(cIdInventario)
...
function altarapidaArticulo(){
    ...
    var url = "xulaltarapida.php?modo=altainventario";
...
function igualStock(){
    ...
    var xrequest = new XMLHttpRequest();
    var xrequest = new XMLHttpRequest();
    var url      = "selkardex.php?modo=kdxIgualExistencias"+
...
function quitaStock(xget){
    ...
    var xrequest = new XMLHttpRequest();
    var url      = "selkardex.php?modo=kdxSalidaExistencias"+
	           "&xarticulo="+cIdArticulo+
	           "&xproducto="+cIdProducto+
	           "&xlocal="+cIdAlmacen+
	           "&xinventario="+cInventario+
...
function getAjusteKardexResumen(){
    ...
    var url = "selkardex.php?modo=xInventarioAlmacenCarrito"+
	      "&xproducto="+cIdProducto+
 	      "&xlocal="+cIdAlmacen+
	      "&xinventario="+cInventario+
...
function agregaStock(xget){
    ...
    var xrequest = new XMLHttpRequest();
    var url      = "selkardex.php?modo=kdxEntradaExistencias"+
	           "&xarticulo="+cIdArticulo+
	           "&xproducto="+cIdProducto+
	           "&xlocal="+cIdAlmacen+
	           "&xinventario="+cInventario+
...
function getAgregaSeries(){
    ...
    var url  = "selcomprar.php?id="+cIdProducto+
...
function exportarInventario(xval){
    ...
    switch(xval){
    case 'pdf':
	var url = "modulos/fpdf/imprimir_inventario.php?" + data;
	location.href=url;
	break;
    case 'cvs':
	var url = "modulos/generadorlistados/exportarlistados.php?"+data+
                  "&modo="+"inventaAjuste";
...
function obtenerNumFilas(xcadena){
    ...
    var url = "selkardex.php?modo=countMovimientosInventario"+xcadena;
    var xrequest = new XMLHttpRequest();
