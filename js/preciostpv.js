...
function eliminarNuevosPV(){
	...
	var listalocal= id("listalocal").value;
 	url = "services.php?modo=eliminarNuevosPV&"+listalocal;
	var xrequest = new XMLHttpRequest();
	xrequest.open("GET",url,false);
	xrequest.send(null);
	if(xrequest.responseText) 
...
function listarPVMD(){
    var listalocal= id("listalocal").value;
    url = "services.php?modo=listarNuevosPV&listalocal="+listalocal;
    var xrequest = new XMLHttpRequest();
    xrequest.open("GET",url,false);
    xrequest.send(null);
    if(xrequest.responseText){
...
function SalvarCambiosSM(numfila,idproducto,idbutton,MDS){
	...
	url = "services.php?modo=actualizarStockMinimo&SM="+SM.value+"&idproducto="+idproducto+"&listalocal="+listalocal;
...
function SalvarCambiosPV(numfila,idproducto,idbutton,MDS){
    ...
    if (MDS == 'PVC' || MDS == 'PVD')
	url = "services.php?modo=guardarPreciosVenta&MDS="+MDS+"&PV="+PV.value+"&PVD="+PVD.value+"&idproducto="+idproducto+"&listalocal="+listalocal;
    var xrequest = new XMLHttpRequest();
    xrequest.open("GET",url,false);
    xrequest.send(null);
    if(xrequest.responseText){
...
function EliminarCambiosPV(numfila,idproducto,idbutton,MDS){
	...
	if (MDS == 'PVC' || MDS == 'PVD')
	    url = "services.php?modo=eliminarCambiosPV&MDS="+MDS+"&PV="+PV.value+"&PVD="+PVD.value+"&idproducto="+idproducto+"&listalocal="+listalocal;
	var xrequest = new XMLHttpRequest();
	xrequest.open("GET",url,false);
	xrequest.send(null);
	if(xrequest.responseText){
...
function getMargenUtilidad(){
    var url = "services.php?modo=mostrarMargenUtilidad";
    var xrequest = new XMLHttpRequest();
    xrequest.open("GET",url,false);
    xrequest.send(null);
...
function getIGV(){
    var url = "services.php?modo=mostrarIGV";
    var xrequest = new XMLHttpRequest();
    xrequest.open("GET",url,false);
    xrequest.send(null);
    return xrequest.responseText;
...
function RawfiltrarProductos(idfamilia,listalocal,idmarca,codigo,descripcion,iniciopagina,idlistarPV,FuncionProcesaLineaProductos,listarTodo){
    ...
    var url = "services.php?modo=mostrarProductosAlmacen&idfamilia=" + idfamilia
        + "&idmarca=" + idmarca
        + "&codigo=" + codigo
