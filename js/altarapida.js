...
function CogeLabHab() {     popup('sellaboratorio.php?modo=laboratoriohab','laboratoriohab');  }
...
function CogeAlias(xid,txtalias) {
    ...
    popup('selproductoalias.php?modo=alias&idfamilia='+idfamilia+'&id='+xid+'&txtalias='+txtalias,'color');  
...
function CogeTallaje(){
    var vfamilia = enviar["IdFamilia"];    
    popup('selcolor.php?modo=xtallaje&idfamilia='+vfamilia,'tallaje');      
}
...
function RegenTallajes() {
		...
		var xrequest = new XMLHttpRequest();
		var url = "selcb.php?modo=tallas&IdTallaje="+mitallaje+'&IdFamilia='+mifamilia;
		xrequest.open("GET",url,false);
		xrequest.send(null);
		var res = xrequest.responseText;
...
function CogeTalla(){    
    ...
    var vfamilia = enviar["IdFamilia"];
    popup('selcolor.php?modo=talla&IdTallaje='+vtallaje+'&idfamilia='+vfamilia,'talla');      
}
...
function CogeColor(){  
    var vfamilia = enviar["IdFamilia"];
    popup('selcolor.php?modo=color&idfamilia='+vfamilia,'color');      
}
...
function RegenColores() {
		VaciarColores();
                ...
                var mifamilia = enviar["IdFamilia"];
		var xrequest = new XMLHttpRequest();
		var url = "selcb.php?modo=colores&IdFamilia="+mifamilia;
...
function CogeContenedor(){  
    VaciarContenedores();
    popup('selcontenedor.php?modo=contenedor','contenedor');      
}
...
function RegenContenedores() {
                ...
                var mifamilia = enviar["IdFamilia"];
		var xrequest = new XMLHttpRequest();
		var url = "selcb.php?modo=contenedores";
		xrequest.open("GET",url,false);
		xrequest.send(null);
		var res = xrequest.responseText;
		var lines = res.split("\n");
...
function resetAllDatos(modo){
    ...
    main.setAttribute("src",'partes-compras/progress.php?modo='+modo+'&aviso='+aviso);
}
