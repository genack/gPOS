...
<window id="CompraVista" title="Establecer Precio Por Pedido"
  ...
  <script type="application/x-javascript" src="js/almacenborrador.js" />
  <script type="application/x-javascript" src="js/tools.js" />
  <script>//<![CDATA[
...
<!--  no-visuales -->
<?php include("partes-compras/almacenborrador.php"); ?>
<!--  no-visuales -->
