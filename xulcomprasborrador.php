...
<window id="CompraVista" title="gPOS // Comprobantes"
  ...
  <script type="application/x-javascript" src="<?php echo $_BasePath; ?>js/comprasborrador.js" />
...
<!--  no-visuales -->
<?php include("partes-compras/comprasborrador.php"); ?>
<!--  no-visuales -->
...
<vbox>
  <spacer style="height:4px"/>
	...
	<button id="btnbuscar" label=" Buscar "  image="img/gpos_buscar.png" oncommand="BuscarCompra()"/>
      </vbox>
    </hbox>
...
<vbox style="margin-top:3em" id="formularioComprobante" align="center"  pack="top" collapsed="true">
  ...
  <hbox collapsed="false">
    ...
    <button id="btnvolveralmacen" class="media" style="font-size:10px;font-weight: bold;" 
	    image="img/gpos_volver.png" label=" Volver Comprobantes" 
