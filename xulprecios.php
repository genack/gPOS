...
<window id="CompraVista" title="gPOS// Precios TPV" 
    ...
    <script type="application/x-javascript" src="js/preciostpv.js" />
  ...
  <hbox  style="background-color: #d7d7d7;padding:3px;"  pack="center">
    ...
    <button id="btnbuscar" label='Buscar' image="img/gpos_buscar.png" oncommand='filtrarProductos()' />
    ...
    <hbox>
      ...
      <button image="img/gpos_listaclientes.png" id="listarPV_MD" label="  Listar Nuevos Precios" 
	      oncommand="listarPVMD()"/>
      <button id="actualizarLPV" image="img/gpos_almacen.png" type="menu" 
	      label="  Aplicar" collapsed="true" <?php gulAdmite("Ventas") ?> >
	<menupopup>
      ...
      <button  image="img/gpos_cancelar.png" id="eliminarLPV" label=" Descartar "  
	       oncommand="eliminarNuevosPV()" collapsed="true" <?php gulAdmite("Ventas") ?>/>   
      <toolbarseparator />
