...
function obtenerDetPresupuestoTPV($TipoPresupuesto,$IdPresupuesto,$IdCliente){
	 ...
	 $sql= 
	   " SELECT ges_presupuestosdet.IdProducto,".
	   "        ges_presupuestosdet.CodigoBarras,Cantidad,".
	   "        CONCAT(Descripcion,'  ',Color,' ',Talla) as Descripcion,".
	   "        Unidades AS CantidadAlmacen,".
	   "        Precio,PrecioVenta,".
	   "        PrecioVentaCorporativo,Importe,".
	   "        ges_presupuestosdet.Descuento,Concepto,ges_productos.Serie".
	   " FROM   ges_presupuestosdet ".
