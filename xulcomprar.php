...
<window id="CompraVista" title="<?php echo "gPOS // Compras - ".$producto?>" 
    ...
    <script type="application/x-javascript" src="<?php echo $_BasePath; ?>js/comprar.js" />
	...
	<rows>
	  ...
	  <row>
 	  ...
 	  <row>
		...
		<button label='Comprar...' image='img/gpos_compras.png' 
			oncommand='aceptar(<?php echo $id.",".$manejaserie.",".$fila.",".$trasAlta?>)'/>
		<button label="Cancelar" image="img/gpos_vaciarcompras.png"
