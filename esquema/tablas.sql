CREATE TABLE `ges_almacenes` (
  ...
  `PrecioVentaEmpaque` double unsigned NOT NULL default '0',
  `PrecioVentaDocena` double unsigned NOT NULL default '0',
  ...
  `UnidadesVitrina` float NOT NULL DEFAULT '0',
  `StockVitrina` float NOT NULL DEFAULT '0',
  `StockVitrinaDevol` float NOT NULL DEFAULT '0',
...
CREATE TABLE `ges_clientes` (
  ...
  `Alta` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `CodigoAlta` varchar(30) NOT NULL,
...
CREATE TABLE `ges_comprobantesdet` (
    ...
    `PrecioAlmacen` double NOT NULL default '0',	
    `Descuento` double NOT NULL default '0',
    `Importe` double NOT NULL default '0',
    `Impuesto` double NOT NULL default '0',
    ...
    `CantidadDevolucion` float NOT NULL DEFAULT '0',
...
CREATE TABLE `ges_locales` (
    ...
    `MetodoRedondeo` enum('SR','RDE','RIE') NOT NULL default 'RDE' comment 'SR:Sin Redondeo,RIDE:Redondeo importe a decimal entero,RIE, Redondeo a ImporteEntero',
    `COPImpuesto` tinyint(1) unsigned NOT NULL default '0',
    `AdmitePassword` tinyint(1) unsigned NOT NULL default '0',
    `CajaCentral` tinyint(1) unsigned NOT NULL default '0',
    `Eliminado` tinyint(1) unsigned NOT NULL default '0',
    PRIMARY KEY  (`IdLocal`),
...
CREATE TABLE `ges_perfiles_usuario` (
  ...
  `PedidosVenta` tinyint(1) NOT NULL DEFAULT '0',
  `Servicios` tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE `ges_productos` (
  ...
  `UnidadMedida` ENUM('und','mts','lts','kls','cjas','bls','mts2','mts3','vllas','pzas','plchs','mdjs','gls','blds','displ','blist','tira','pack','saco') NOT NULL DEFAULT 'und',
...
CREATE TABLE `ges_subfamilias` (
  ...
  `MargenUtilidadVD` double unsigned NOT NULL default '0',
  `MargenUtilidadVC` double unsigned NOT NULL default '0',
  `Descuento` double unsigned NOT NULL default '0',
  `Eliminado` tinyint(1) unsigned NOT NULL default '0',
  PRIMARY KEY  (`Id`),
...
CREATE TABLE  `ges_comprobantesprov` (
  ...
  `TipoComprobanteGiro` ENUM('Comercializacion','Produccion') NOT NULL DEFAULT 'Comercializacion' COMMENT 'Diferencia facturas por el uso del detalle',
  ...
  `ImporteBase` double unsigned NOT NULL DEFAULT '0',
  `ImporteImpuesto` double unsigned NOT NULL DEFAULT '0',
  `ImportePercepcion` double unsigned NOT NULL DEFAULT '0',
  `ImporteFlete` double unsigned NOT NULL DEFAULT '0',
  `TotalImporte` double NOT NULL DEFAULT '0',
  `ImportePago` double NOT NULL DEFAULT '0',
  `ImportePendiente` double NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ges_presupuestos` (
  ...
  `ImporteAdelanto` double NOT NULL DEFAULT '0',
  `Eliminado` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ges_ordenservicio` (
  ...
  `Tipo` enum('Regular','Garantia')NOT NULL DEFAULT 'Regular',
...
CREATE TABLE IF NOT EXISTS `ges_ordenserviciodet` (
  ...
  `FechaChange` TIMESTAMP ON UPDATE CURRENT_TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `Estado` enum('Pendiente','Ejecucion','Finalizado','Cancelado') NOT NULL DEFAULT 'Pendiente',
...
CREATE TABLE IF NOT EXISTS `ges_suscripciones` (
  ...
  `Comprobante` enum('Factura','Boleta','Ticket') NOT NULL DEFAULT 'Ticket',
...
CREATE TABLE IF NOT EXISTS `ges_dwgroups` (
...
CREATE TABLE IF NOT EXISTS `ges_dwusergroup` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0' comment 'IdCliente',
...
CREATE TABLE IF NOT EXISTS `ges_cobrosclientedoc` (
  ...
  `IdClienteCredito` MEDIUMINT unsigned NOT NULL DEFAULT '0',
  `FechaRegistro` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  `FechaOperacion` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `CodOperacion` tinytext NOT NULL,
  `Documento` tinytext NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ges_guiaremision` (
  `IdGuiaRemision` INT unsigned NOT NULL AUTO_INCREMENT,
  `IdLocal` int(10) unsigned NOT NULL DEFAULT '0',
  `IdUsuario` int(10) unsigned NOT NULL DEFAULT '0',
  `IdComprobanteNum` bigint(20) UNSIGNED NOT NULL default '0',
  `IdSubsidiario` smallint(5) unsigned NOT NULL default '0',
  `IdComprobanteProv` bigint(20) unsigned NOT NULL default '0',
  `IdMotivoAlbaran` tinyint unsigned NOT NULL DEFAULT '0' comment 'Motivo Traslado',  
  `TipoGuia` enum('Remitente','Transportista','Proveedor') NOT NULL DEFAULT 'Remitente',
  `FechaRegistro` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  `FechaEmision` datetime NOT NULL default '0000-00-00 00:00:00',
  `FechaInicioTraslado` datetime NOT NULL default '0000-00-00 00:00:00',
  `NumeroSerie` char(4) NOT NULL,
  `NumeroGuia` char(11) NOT NULL,
  `MotivoTraslado` tinytext NOT NULL,
  `PuntoPartida` varchar(100) NOT NULL,
  `PuntoLlegada` varchar(100) NOT NULL,
  `MarcaUnidadTransp` varchar(50) NOT NULL,
  `PlacaUnidadTransp` char(7) NOT NULL,
  `LicenciaConductor` varchar(15) NOT NULL,
  `Peso` double NOT NULL default '0',
  `UnidadPeso` enum('KLG','TN') NOT NULL DEFAULT 'TN',
  `Eliminado` tinyint(1) unsigned NOT NULL DEFAULT '0',
