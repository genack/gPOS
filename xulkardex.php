...
<window id="MovimientoVista" title="Movimientos Kardex"
  ...
  <script type="application/x-javascript" src="<?php echo $_BasePath; ?>js/kardex.js" />
...
<vbox id="busquedaMovimiento">
  <hbox align="start" pack="center" style="background-color: #d7d7d7;padding:3px;">
    ...
    <vbox style="margin-top:.9em">
      <button id="btnbuscar" label=" Buscar "  image="img/gpos_buscar.png" oncommand="BuscarMovimiento()"/>
    </vbox>
    <vbox>
    <description value=""/>
