 	...
 	$sql = "
			SELECT 
			 ...
			 WHERE   
				      ...
				      ges_productos.IdColor = ges_modelos.IdColor  AND 
				      ges_productos.IdTalla = ges_detalles.IdTalla AND 
...
//################### MENSAJE FOOTER 
	  ...
	  $pdf->Cell(1);
          ...
          $pdf->Ln(3);	
          $pdf->SetFont('Arial','B',9);
          $pdf->Cell(172,4,"TPV: ".getSesionDato("TipoVentaTPV")." / Nro Boleta: ".$nroBoleta." / CS: ".$codlist." / OP: ".$operador." / F.Imp.: ".$hora." ".$fecha,'LR',0,'C');
	  $pdf->Cell(20,4,"",'LR',0,'C');
	  $pdf->Cell(25,4,"",'LR',0,'C');
          //############## LINEA 3
          $pdf->Ln(1);	
...
//#######################  final de la Boleta
    ...
    $pdf->Cell(146,4,$totalneto,1,0,'R',1);
