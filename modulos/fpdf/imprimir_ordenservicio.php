...
$IdOrdenServicio = CleanID($_GET["idoc"]);
...
$pdf->Ln(2);	
  ...
  $sql = "SELECT IdOrdenServicioDet, ".
	 ...
	 "INNER JOIN ges_marcas       ON ges_productos.IdMarca  = ges_marcas.IdMarca ".
	  ...
	  $pdf->Cell(172,4,utf8_decode($acotado[0]),'',0,'L');
	  $pdf->Ln(4); 
	  ...
	  if($xtiposerv[1] == 1 ){
	      ...
	      $pdf->SetX(37); 
	      $pdf->SetFont('','');	
	      $pdf->Cell(172,4,utf8_decode($aMotivo[0]),'',0,'L');
	      $pdf->Ln(4);
	      ...
	      $pdf->SetX(45); 
	      $pdf->SetFont('','');	
	      $pdf->Cell(172,4,utf8_decode($aDiagnostico[0]),'',0,'L');
	      $pdf->Ln(4);
		...
		if($key>0 && $key < 27 ){
	      ...
	      $pdf->SetX(43); 
	      $pdf->SetFont('','');
	      $pdf->Cell(120,4,utf8_decode($aSolucion[0]),'',0,'L');
	      $pdf->Ln(4);
