...
<?php include("tpvmensajeria.php"); ?>
 ...
 <hbox>
	<button flex="1" id="VerVentasButton" crop="end" image="img/gpos_tpv_ventas.png" label="<?php echo _(" Ventas") ?>"  class="compacta" oncommand="VerVentas()"/>		
	<?php if($modulos["arreglodecaja"]): ?>
	<button flex="1" id="VerCajaButton" crop="end" image="img/gpos_tpvcaja.png" label="<?php echo _(" Caja") ?>"  class="compacta" oncommand="VerCaja()" <?php gulAdmite("CajaTPV") ?>/>
	<?php endif; ?>
 </hbox>
 <hbox>
